    ...
    return remember {
        ImageVector.Builder(
            ...
            path(
                ...
                moveTo(14.3171f, 2.07315f)
                curveTo(14.7589f, 2.2353f, 15.0278f, 2.6836f, 14.9629f, 3.1497f)
                lineTo(14.1488f, 8.99998f)
                horizontalLineTo(17f)
                curveTo(17.3652f, 9f, 17.7013f, 9.199f, 17.8768f, 9.5192f)
                ...
                lineTo(9.84352f, 15f)
                horizontalLineTo(7f)
                curveTo(6.6353f, 15f, 6.2994f, 14.8014f, 6.1237f, 14.4818f)
                curveTo(5.948f, 14.1621f, 5.9602f, 13.7722f, 6.1556f, 13.4642f)
                lineTo(13.1281f, 2.4761f)
                curveTo(13.3802f, 2.0787f, 13.8753f, 1.911f, 14.3171f, 2.0732f)
                close()
                moveTo(8.81888f, 13f)
                horizontalLineTo(11f)
                curveTo(11.2904f, 13f, 11.5665f, 13.1262f, 11.7564f, 13.3459f)
                curveTo(11.9464f, 13.5656f, 12.0315f, 13.857f, 11.9895f, 14.1444f)
                lineTo(11.6391f, 16.546f)
                lineTo(15.1762f, 11f)
                horizontalLineTo(13f)
                curveTo(12.7107f, 11f, 12.4357f, 10.8747f, 12.2457f, 10.6566f)
                curveTo(12.0558f, 10.4384f, 11.9697f, 10.1487f, 12.0095f, 9.8622f)
                lineTo(12.3465f, 7.44068f)
                lineTo(8.81888f, 13f)
                close()
            }
        }.build()
