package io.github.madmaximuus.persianIcons.add
...
import io.github.madmaximuus.persianIcons.foundation.PersianIcons

@Composable
fun PersianIcons.Default.add(
    color: Color
): ImageVector {
    if (add != null) {
        return add!!
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianIcons.Default.add(Color.Red),
                contentDescription = ""
            )
        }
    }
