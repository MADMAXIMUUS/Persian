package io.github.madmaximuus.persianSymbols.battery.six.base
    ...
    get() {
        ...
        battery6 = Builder(
            ...
            path(
                ...
                lineTo(18.0f, 19.4001f)
                curveTo(18.0f, 20.7912f, 16.9075f, 21.9271f, 15.5337f, 21.9967f)
                curveTo(15.4894f, 21.9989f, 15.4448f, 22.0001f, 15.4f, 22.0001f)
                curveTo(15.4f, 22.0001f, 15.4f, 22.0001f, 15.4f, 22.0001f)
                horizontalLineTo(8.6f)
                curveTo(7.1641f, 22.0001f, 5.9999f, 20.836f, 5.9999f, 19.4001f)
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Default.Battery6,
                contentDescription = ""
            )
        }
    }
