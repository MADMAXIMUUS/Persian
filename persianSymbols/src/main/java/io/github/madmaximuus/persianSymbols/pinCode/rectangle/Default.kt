    ...
    get() {
        ...
        pinCodeRectangle = Builder(
            ...
            path(
                ...
                close()
                moveTo(4f, 8.4f)
                curveTo(4f, 7.074f, 5.074f, 6f, 6.4f, 6f)
                horizontalLineTo(17.6f)
                curveTo(18.925f, 6f, 20f, 7.074f, 20f, 8.4f)
                verticalLineTo(15.6f)
                curveTo(20f, 16.925f, 18.925f, 18f, 17.6f, 18f)
                horizontalLineTo(6.4f)
                curveTo(5.074f, 18f, 4f, 16.925f, 4f, 15.6f)
                verticalLineTo(8.4f)
                close()
            }
        }.build()
