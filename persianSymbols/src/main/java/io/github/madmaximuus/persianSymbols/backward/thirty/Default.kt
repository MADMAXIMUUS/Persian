package io.github.madmaximuus.persianSymbols.backward.thirty
...
val PersianSymbols.Default.Backward30: ImageVector
    get() {
        if (backward30 != null) {
            return backward30!!
        }
        backward30 = Builder(
            ...
            path(
                ...
                moveTo(9.398f, 12.1841f)
                curveTo(9.2205f, 12.1841f, 9.0767f, 12.3279f, 9.0767f, 12.5054f)
                curveTo(9.0767f, 12.6828f, 9.2205f, 12.8267f, 9.398f, 12.8267f)
                horizontalLineTo(9.5688f)
                ...
                curveTo(8.1847f, 13.7051f, 7.991f, 13.8933f, 8.053f, 14.1122f)
                curveTo(8.0737f, 14.1853f, 8.1005f, 14.2547f, 8.1333f, 14.3203f)
                curveTo(8.2245f, 14.4958f, 8.3475f, 14.6427f, 8.5024f, 14.7612f)
                curveTo(8.6574f, 14.8774f, 8.8329f, 14.9652f, 9.0288f, 15.0244f)
                curveTo(9.2248f, 15.0837f, 9.4298f, 15.1133f, 9.644f, 15.1133f)
                ...
                curveTo(10.2422f, 10.0535f, 9.9619f, 10.0f, 9.6406f, 10.0f)
                curveTo(9.3398f, 10.0f, 9.0687f, 10.0592f, 8.8272f, 10.1777f)
                ...
                curveTo(9.9186f, 12.151f, 9.7603f, 12.1841f, 9.5688f, 12.1841f)
            ...
            path(
                ...
                curveTo(14.1283f, 10.0251f, 13.946f, 10.0f, 13.7478f, 10.0f)
                curveTo(13.5017f, 10.0f, 13.2784f, 10.0387f, 13.0778f, 10.1162f)
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Default.Backward30,
                contentDescription = ""
            )
        }
    }
