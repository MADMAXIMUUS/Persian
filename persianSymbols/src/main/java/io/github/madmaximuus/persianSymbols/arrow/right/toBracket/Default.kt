    ...
    get() {
        ...
        arrowRightToBracket = ImageVector.Builder(
            ...
            path(
                ...
                lineTo(11.707f, 7.2929f)
                curveTo(11.3164f, 6.9024f, 10.6833f, 6.9024f, 10.2928f, 7.2929f)
                curveTo(9.9022f, 7.6834f, 9.9022f, 8.3166f, 10.2928f, 8.7071f)
                lineTo(12.5857f, 11.0f)
                horizontalLineTo(4.9999f)
                curveTo(4.4476f, 11.0f, 3.9999f, 11.4477f, 3.9999f, 12.0f)
                curveTo(3.9999f, 12.5523f, 4.4476f, 13.0f, 4.9999f, 13.0f)
