package io.github.madmaximuus.persianSymbols.xmark.base
    ...
    get() {
        ...
        xMark = ImageVector.Builder(
            ...
            path(
                ...
                lineTo(6.3467f, 4.9325f)
                curveTo(5.9562f, 4.542f, 5.3214f, 4.5404f, 4.9289f, 4.9289f)
                curveTo(4.5365f, 5.3175f, 4.5349f, 5.9491f, 4.9254f, 6.3396f)
                lineTo(10.5858f, 12.0f)
                lineTo(4.9254f, 17.6604f)
                close()
            }
        }.build()
        return xMark!!
