    ...
    get() {
        ...
        deviceTabletAndroid = Builder(
            ...
            path(
                ...
                moveTo(4.0f, 6.5f)
                curveTo(4.0f, 4.0147f, 6.0147f, 2.0f, 8.5f, 2.0f)
                horizontalLineTo(15.5f)
                curveTo(17.9853f, 2.0f, 20.0f, 4.0147f, 20.0f, 6.5f)
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Default.DeviceTabletAndroid,
                contentDescription = ""
            )
        }
    }
