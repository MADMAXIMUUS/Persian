    ...
    get() {
        ...
        volumeHigh = Builder(
            ...
            path(
                ...
                moveTo(8.2034f, 8.0001f)
                horizontalLineTo(4.0f)
                curveTo(2.8954f, 8.0001f, 2.0f, 8.8955f, 2.0f, 10.0001f)
                verticalLineTo(14.0001f)
                curveTo(2.0f, 15.1046f, 2.8954f, 16.0001f, 4.0f, 16.0001f)
                horizontalLineTo(8.2034f)
                curveTo(8.4251f, 16.0001f, 8.6406f, 16.0737f, 8.8158f, 16.2095f)
                lineTo(13.3876f, 19.751f)
                curveTo(14.0447f, 20.2601f, 15.0f, 19.7917f, 15.0f, 18.9605f)
                verticalLineTo(5.0396f)
                curveTo(15.0f, 4.2084f, 14.0447f, 3.7401f, 13.3876f, 4.2491f)
                lineTo(8.8158f, 7.7906f)
                curveTo(8.6406f, 7.9264f, 8.4251f, 8.0001f, 8.2034f, 8.0001f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Filled.VolumeHigh,
                contentDescription = ""
            )
        }
    }
