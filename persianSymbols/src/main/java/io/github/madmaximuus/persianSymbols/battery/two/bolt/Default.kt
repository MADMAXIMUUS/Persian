package io.github.madmaximuus.persianSymbols.battery.two.bolt
...
val PersianSymbols.Default.Battery2Bolt: ImageVector
    get() {
        if (battery2Bolt != null) {
            return battery2Bolt!!
        }
        battery2Bolt = Builder(
            name = "battery-2-bolt-default",
            ...
            path(
                ...
                moveTo(11.6263f, 16.0001f)
                lineTo(14.3039f, 11.8017f)
                ...
                lineTo(11.1344f, 16.0001f)
                horizontalLineTo(11.6263f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
...
private var battery2Bolt: ImageVector? = null
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Default.Battery2Bolt,
                contentDescription = ""
            )
        }
    }
