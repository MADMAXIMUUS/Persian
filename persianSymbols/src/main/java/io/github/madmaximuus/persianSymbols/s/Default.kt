    ...
    get() {
        ...
        s = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(17.25f, 19.149f, 14.899f, 21.5f, 12f, 21.5f)
                curveTo(9.815f, 21.5f, 7.943f, 20.165f, 7.153f, 18.27f)
                curveTo(6.94f, 17.761f, 7.181f, 17.175f, 7.691f, 16.962f)
                curveTo(8.2f, 16.75f, 8.786f, 16.991f, 8.999f, 17.5f)
                curveTo(9.489f, 18.676f, 10.65f, 19.5f, 12f, 19.5f)
                ...
                curveTo(6.75f, 4.85f, 9.1f, 2.5f, 12f, 2.5f)
                ...
                curveTo(14.537f, 5.342f, 13.366f, 4.5f, 12f, 4.5f)
                close()
            }
        }.build()
