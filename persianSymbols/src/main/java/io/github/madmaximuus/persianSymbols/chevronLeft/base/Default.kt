package io.github.madmaximuus.persianSymbols.chevronLeft.base
    ...
    get() {
        ...
        chevronLeft = ImageVector.Builder(
            ...
            path(
                ...
                lineTo(14.6644f, 8.7394f)
                curveTo(15.0549f, 8.3489f, 15.0516f, 7.7191f, 14.6569f, 7.3328f)
                curveTo(14.2622f, 6.9464f, 13.6257f, 6.9498f, 13.2352f, 7.3404f)
                lineTo(9.0043f, 11.5713f)
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Default.ChevronLeft,
                contentDescription = ""
            )
        }
    }
