    ...
    get() {
        ...
        deviceLaptopMacbook = Builder(
            ...
            path(
                ...
                curveTo(22.0f, 16.9136f, 21.3482f, 18.175f, 20.3287f, 19.0f)
                ...
                horizontalLineTo(3.6713f)
                curveTo(2.6518f, 18.175f, 2.0f, 16.9136f, 2.0f, 15.5f)
                verticalLineTo(8.5f)
                close()
                moveTo(6.5f, 6.0f)
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Default.DeviceLaptopMacbook,
                contentDescription = ""
            )
        }
    }
