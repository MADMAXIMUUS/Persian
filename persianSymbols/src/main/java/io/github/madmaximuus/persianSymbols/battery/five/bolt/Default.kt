    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Default.Battery5Bolt,
                contentDescription = ""
            )
        }
    }
