    ...
    get() {
        ...
        bell = Builder(
            ...
            path(
                ...
                curveTo(8.1623f, 3.4965f, 6.0f, 5.9645f, 6.0f, 8.9375f)
                ...
                curveTo(18.0f, 5.9645f, 15.8377f, 3.4965f, 13.0f, 3.0205f)
                verticalLineTo(3.0f)
                close()
                moveTo(16.0f, 8.9375f)
                verticalLineTo(17.0f)
                horizontalLineTo(8.0f)
                verticalLineTo(8.9375f)
                curveTo(8.0f, 6.97f, 9.4205f, 5.3343f, 11.2918f, 5.0f)
                horizontalLineTo(12.7082f)
                curveTo(14.5795f, 5.3343f, 16.0f, 6.97f, 16.0f, 8.9375f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
    ...
    MaterialTheme {
        Surface {
            Icon(
                ...
                imageVector = PersianSymbols.Default.Bell,
                contentDescription = ""
            )
        }
    }
