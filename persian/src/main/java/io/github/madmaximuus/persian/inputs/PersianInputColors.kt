...
object PersianInputColors {
    ...
    fun primary(
        ...
        unfocusedTrailingIconColor: Color = MaterialTheme.extendedColorScheme.onSurfaceVariant,
        disabledTrailingIconColor: Color = MaterialTheme.extendedColorScheme.onSurfaceVariant
            .copy(alpha = PersianContentStateDisabled),
        errorTrailingIconColor: Color = MaterialTheme.extendedColorScheme.onSurfaceVariant,
        successTrailingIconColor: Color = MaterialTheme.extendedColorScheme.onSurfaceVariant,
        ...
        unfocusedSuffixColor: Color = MaterialTheme.extendedColorScheme.onSurfaceVariant,
        disabledSuffixColor: Color = MaterialTheme.extendedColorScheme.onSurface
            .copy(alpha = PersianContentStateDisabled),
        errorSuffixColor: Color = MaterialTheme.extendedColorScheme.error,
        successSuffixColor: Color = MaterialTheme.extendedColorScheme.onSurfaceVariant,
    ): InputColors =
        InputColors(
            //State Icon
